      ...
      <main className="home-background min-h-screen bg-cover bg-no-repeat">
        ...
        <div className="flex flex-col justify-around items-center pt-80 pb-20 md:flex-row md:justify-around md:items-start">
          <section className="flex-col w-2/3 md:w-1/3 md:text-left text-center">
            <h2 className="home-h2 text-3xl pb-2 tracking-widest text-secondary">SO, YOU WANT TO TRAVEL TO</h2>
            <h2 className="space text-9xl md:text-[150px] pb-2 text-tertiary">SPACE</h2>
            <p className="parrafo text-lg text-secondary">
              Let’s face it; if you want to go to space, you might as well genuinely go to outer space and not hover kind of on the edge of it. Well sit back, and relax because we’ll give you a truly out of this world experience!
            </p>
          </section>
          <section className="pt-60 md:pt-16 flex justify-center items-center">
